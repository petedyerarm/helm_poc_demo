...
docker build -t containers.us-east-1.mbedcloud.com/"${accountId}"/parsec_poc_demo:v1 -f Dockerfile .
docker push  containers.us-east-1.mbedcloud.com/"${accountId}"/parsec_poc_demo:v1
